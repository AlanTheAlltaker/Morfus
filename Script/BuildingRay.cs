...
public class BuildingRay : NetworkBehaviour
{
    ...
    [SerializeField] GameObject blueWall;

    [SerializeField] GameObject redSentry;
    [SerializeField] GameObject blueSentry;
    ...
    [SerializeField] bool HealingStationHand;
    ...
    private void OnEnable()
    {
        ...
        if (Teleport)
        {
            if (!structureHolder.tI)
            {
                HideServerRpc(false);
            }
        }
        if (HealingStationHand)
        {
            if (!structureHolder.hSI)
            {
                HideServerRpc(false);
            }
        }
    ...
    void FPClientRpc()
    {
        ...
        if (CannonWarMachine)
        {
            structureHolder.cWMI = false;
        }
        if (Teleport)
        {
            structureHolder.tI = false;
        }
        if (HealingStationHand)
        {
            structureHolder.hSI = false;
        }
        if (TokenCollector)
        {
            structureHolder.tCI = false;
        }
    }
}
